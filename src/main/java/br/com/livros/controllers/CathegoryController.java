...
import br.com.livros.services.implementation.CathegoryServiceImpl;
...
public class CathegoryController {
	...
	@CrossOrigin(origins = "http://localhost:4200")
//	@Operation(summary = "Saves Cathegories of Books ")
//	@ApiResponses(value = {
...
//			@ApiResponse(responseCode = "404", description = "Cathegory Not Saved" )}) 
	...
	public ResponseEntity<Cathegory> save(@RequestBody @Valid Cathegory categories) {			
	        return new ResponseEntity<Cathegory>(categoriaservico.save(categories),HttpStatus.CREATED);
